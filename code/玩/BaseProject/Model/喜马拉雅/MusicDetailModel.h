...
@class MusicDetailAlbumModel,MusicTracksModel,MusicDetailListModel;
@interface MusicDetailModel : BaseModel

@property (nonatomic, strong) MusicTracksModel *tracks;
...
@end
@interface MusicDetailAlbumModel : NSObject
...
@interface MusicTracksModel : NSObject

@property (nonatomic, assign) NSInteger maxPageId;

@property (nonatomic, strong) NSArray<MusicDetailListModel *> *list;
...
@interface MusicDetailListModel : NSObject
